...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/jsp/css/order/pay.css'/>">
...
<body>
	...
	<form action="<c:url value='/OrderServlet'/>" method="post" id="form1"
		target="_top">
		<input type="hidden" name="method" value="buy" /> <input type="hidden"
			name="oid" value="${order.oid }" />
		<div class="divBank">
			...
			<div style="margin: 40px;">
					<%-- <a href="/BookStore/OrderServlet?method=buy&oid=${order.oid }"
					class="linkNext">下一步</a> --%>
