...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/jsp/css/user/login.css'/>">
<script type="text/javascript"
	src="<c:url value='/jquery/jquery-1.5.1.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/jsp/js/user/login.js'/>"></script>
<script src="<c:url value='/js/common.js'/>"></script>

<script type="text/javascript">
		$(function(){//Map<String(Cookie名称),Cookie(Cookie本身)>
		//获取cookie中的用户名
		   var loginname=window.decodeURI("${cookie.loginname.value}");//它会先执行,因为之前以及使用URL编码，所以要进行解码
...
<body>
	<div class="main">
		...
		<div>
			...
			<div class="login1" style="position: fixed;top: 50px;left: 188px;">
				<div class="login2">
							...
							<table>
								...
								<tr>
									...
									<td><input class="input yzm" type="text" name="verifyCode"
										...
										src="/BookStore/VerifyCodeServlet" /> <a id="verifyCode"
										href="javascript:_change()">换张图</a></td>
								</tr>
								<tr>
									<td height="20px">&nbsp;</td>
								...
								<tr>
									...
									<td align="left"><input type="image" id="submit"
										...
										<a href="<c:url value='/jsp/user/regist.jsp'/>"
										class="registBtn"></a></td>
								</tr>
							</table>
						</form>
