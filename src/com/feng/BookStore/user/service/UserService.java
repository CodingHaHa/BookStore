package com.feng.BookStore.user.service;
...
import com.feng.BookStore.user.dao.UserDao;
...
public class UserService {
	...
	public void regist(User user){
		...
		//MessageFormat.format方法会把第一个参数中的{0}用第二个参数替换
		//例如MessageFormat.format("你好{0}","你{1}","张三","去睡");返回你好张三你去死
